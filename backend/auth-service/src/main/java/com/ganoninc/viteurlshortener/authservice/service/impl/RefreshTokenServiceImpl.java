...
public class RefreshTokenServiceImpl implements RefreshTokenService {
    ...
    public RefreshTokenServiceImpl(RefreshTokenRepository refreshTokenRepository, PasswordEncoder encoder, JwtUtils jwtUtils) {
    ...
    public TokenPairDto validateAndRotateTokens(String rawRefreshToken) {
        ...
        RefreshTokenMapping currentRefreshTokenMapping = refreshTokenRepository.findByIdForUpdate(tokenId)
                .orElseThrow(
    ...
    @Transactional
    protected TokenPairDto rovokeCurrentTokenAndCreateNewTokens(RefreshTokenMapping currentRefreshTokenMapping) {
        ...
        currentRefreshTokenMapping.setReplacement(refreshTokenRepository.findById(
                UUID.fromString(
                        newRefreshToken.split("\\.")[0]
                ))
    ...
    private void validateCurrentRefreshToken(RefreshTokenMapping currentRefreshTokenMapping, String token) {
