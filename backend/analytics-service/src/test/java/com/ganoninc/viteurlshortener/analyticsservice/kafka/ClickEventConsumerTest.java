...
@SpringBootTest(classes = {ClickEventConsumer.class})
public class ClickEventConsumerTest {
    ...
    @Test
    public void itShouldTNotSaveAClickEventEntityWhenItReceivesAnInvalidUrlClickedEvent() throws JSONException {
        JSONObject incompleteMessagePayload = FakeKafkaUrlClickedMessagePayload.getFakeIncompletePayload();
    ...
    public void itShouldLogAnErrorWhenItReceivesAnInvalidUrlClickedEvent() throws JSONException {
        ...
        assertThat(logCaptor.getErrorLogs()).containsExactly("Failed to process click event message: " + incompleteMessagePayload.toString());
    }
