...
class UrlServiceImplTest {
    ...
    void itShouldCreateUrlMappingAndSendEvent() {
        ...
        UrlMapping saved = FakeUrlMapping.builder()
                .shortId("abcd1234")
    ...
    void itShouldReturnUserUrls() {
        UrlMapping url1 = FakeUrlMapping.builder()
                .shortId("abc12345")
                .build();
        UrlMapping url2 = FakeUrlMapping.builder()
                .shortId("abc12346")
                .build();
    ...
    void itShouldReturnUserUrlDetailsWithValidShortId(){
        UrlMapping url = FakeUrlMapping.builder()
                .userEmail(userEmail)
                .originalUrl(originalUrl)
                .build();
