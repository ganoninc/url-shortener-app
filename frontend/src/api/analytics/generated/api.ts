...
export interface PaginatedSliceClickEventDTOString {
    /**
     * Items returned in this cursor slice. This list represents only a window of the full dataset, limited by the requested page size, and ordered consistently according to the API’s contract. 
