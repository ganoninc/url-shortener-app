...
export const UrlControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getUserUrl: async (shortId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'shortId' is not null or undefined
            assertParamExists('getUserUrl', 'shortId', shortId)
            const localVarPath = `/my-urls/{shortId}`
...
export const UrlControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserUrl(shortId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserUrlDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUserUrl(shortId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['UrlControllerApi.getUserUrl']?.[localVarOperationServerIndex]?.url;
...
export const UrlControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getUserUrl(shortId: string, options?: RawAxiosRequestConfig): AxiosPromise<UserUrlDTO> {
            return localVarFp.getUserUrl(shortId, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns the list of shortened URL created by the user
         * @summary Get user\'s URLs
...
export class UrlControllerApi extends BaseAPI {
     ...
     */
    public getUserUrl(shortId: string, options?: RawAxiosRequestConfig) {
        return UrlControllerApiFp(this.configuration).getUserUrl(shortId, options).then((request) => request(this.axios, this.basePath));
    }
